...
open class CameraBaseFragment : Fragment(), View.OnClickListener,
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@CameraBaseFragment.cameraDevice = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@CameraBaseFragment.cameraDevice = null
        }

        override fun onError(cameraDevice: CameraDevice, error: Int) {
            onDisconnected(cameraDevice)
            this@CameraBaseFragment.activity?.finish()
        }
    ...
    /**
     * Opens the camera specified by [CameraBaseFragment.cameraId].
     */
    ...
    companion object {
         ...
         * Tag for the [Log].
         */
        private val TAG = "CameraBaseFragment"
