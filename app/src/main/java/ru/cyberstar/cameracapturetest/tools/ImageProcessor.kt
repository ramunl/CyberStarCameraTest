...
import com.priyankvasa.android.cameraviewex.ScriptC_yuv420888
...
fun Image.decode(outputFormat: Int, rs: RenderScript): ByteArray {
...
internal object ImageProcessor {
    ...
    fun yuvToRgbNative(image: Image, rs: RenderScript): ByteArray {
        ...
        val outAlloc =
            Allocation.createFromBitmap(rs, outBitmap, Allocation.MipmapControl.MIPMAP_NONE, Allocation.USAGE_SCRIPT)
